...
layer parse_deconvolutional(list* options, size_params params)
{
  ...
  layer l = make_deconvolutional_layer(batch, h, w, c, n, size, stride, padding, activation, batch_normalize,
                                       params.net->adam);
...
convolutional_layer parse_convolutional(list* options, size_params params)
{
  ...
  convolutional_layer layer = make_convolutional_layer(batch, h, w, c, n, groups, size, stride, padding, activation,
...
layer parse_rnn(list* options, size_params params)
{
  ...
  layer l = make_rnn_layer(params.batch, params.inputs, output, params.time_steps, activation, batch_normalize,
                           params.net->adam);
...
void load_connected_weights(layer l, FILE* fp, int transpose)
{
  ...
  // printf("Weights: %f mean %f variance\n", mean_array(l.weights, l.outputs*l.inputs), variance_array(l.weights,
  // l.outputs*l.inputs));
  if (l.batch_normalize && (!l.dontloadscales))
  {
    ...
    // variance_array(l.rolling_mean, l.outputs));
