...
void delta_region_class(float* output, float* delta, int index, int class, int classes, tree* hier, float scale,
                        int stride, float* avg_cat, int tag)
{
  int i, n;
  if (hier)
  {
...
void forward_region_layer(const layer l, network net)
{
  ...
  if (l.softmax_tree)
  {
    ...
    for (i = 0; i < l.softmax_tree->groups; ++i)
    {
      ...
      softmax_cpu(net.input + count, group_size, l.batch, l.inputs, l.n * l.w * l.h, 1, l.n * l.w * l.h, l.temperature,
                  l.output + count);
      count += group_size;
    }
  }
  else if (l.softmax)
  {
    ...
    softmax_cpu(net.input + index, l.classes + l.background, l.batch * l.n, l.inputs / l.n, l.w * l.h, 1, l.w * l.h, 1,
                l.output + index);
  }
#endif
  ...
  *(l.cost) = 0;
  for (b = 0; b < l.batch; ++b)
  {
    if (l.softmax_tree)
    {
      ...
      for (t = 0; t < 30; ++t)
      {
        ...
        if (truth.x > 100000 && truth.y > 100000)
        {
          ...
          delta_region_class(l.output, l.delta, class_index, class, l.classes, l.softmax_tree, l.class_scale, l.w * l.h,
                             &avg_cat, !l.softmax);
    ...
    for (t = 0; t < 30; ++t)
    {
      ...
      float iou = delta_region_box(truth, l.output, l.biases, best_n, box_index, i, j, l.w, l.h, l.delta,
...
void forward_region_layer_gpu(const layer l, network net)
{
  ...
  if (l.softmax_tree)
  {
    ...
    softmax_tree(net.input_gpu + index, l.w * l.h, l.batch * l.n, l.inputs / l.n, 1, l.output_gpu + index,
                 *l.softmax_tree);
  }
  else if (l.softmax)
  {
    int index = entry_index(l, 0, 0, l.coords + !l.background);
    softmax_gpu(net.input_gpu + index, l.classes + l.background, l.batch * l.n, l.inputs / l.n, l.w * l.h, 1, l.w * l.h,
                1, l.output_gpu + index);
  }
